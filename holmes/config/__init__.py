...
Config.define("MAX_IMG_REQUESTS_PER_PAGE", 50, "Maximun number of images per page", "Image Request Validator")
Config.define("MAX_KB_SINGLE_IMAGE_AFTER_GZIP", 100, "Maximun size of a single image after gzip", "Image Request Validator")
Config.define("MAX_IMG_KB_PER_PAGE_AFTER_GZIP", 1000, "Maximun size of images per page after gzip", "Image Request Validator")
